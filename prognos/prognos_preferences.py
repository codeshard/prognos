...
class OptionsDialog(QtGui.QDialog):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle(self.tr('Opciones'))
        self.resize(400, 300)
        ...
        self.comboBox_language.addItem(_translate(None, "Español", None))
        self.comboBox_language.addItem(_translate(None, "English", None))
        ...
        self.groupBox_2.setTitle(_translate(None, self.tr("Ubicación"), None))
        self.label_5.setText(_translate(None, self.tr("Seleccione Ubicación:"), None))
        self.groupBox_3.setTitle(_translate(None, self.tr("General:"), None))
        self.label_6.setText(_translate(None, self.tr("Temperatura:"), None))
        self.label_7.setText(_translate(None, self.tr("Lenguaje:"), None))
        self.groupBox.setTitle(_translate(None, self.tr("Autenticación"), None))
        self.checkBox.setText(_translate(None, self.tr("Usar HTTP-Proxy"), None))
        self.label.setText(_translate(None, self.tr("Host:"), None))
        self.lineEdit_host.setInputMask(_translate(None, "000.000.000.000; ", None))
        self.label_2.setText(_translate(None, self.tr("Puerto:"), None))
        self.lineEdit_port.setInputMask(_translate(None, "0000; ", None))
        self.label_3.setText(_translate(None, self.tr("Usuario:"), None))
    ...
    def _init(self):
        ...
        self.comboBox_language.setCurrentIndex(int(language))
        if proxy == 'true':
    ...
    def _settings(self):
        ...
        settings.setValue("language", self.comboBox_language.currentIndex())
